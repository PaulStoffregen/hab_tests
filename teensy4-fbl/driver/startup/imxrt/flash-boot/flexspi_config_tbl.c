#ifndef FLEXSPI_CONFIG_TBL_C
#define FLEXSPI_CONFIG_TBL_C
#endif /* FLEXSPI_CONFIG_TBL_C */

#include "bsp.h"


#define __flash_cfg_sect __attribute__ ((section(".flash_cfg"), used))

__flash_cfg_sect uint32 flexSpiNorCfgTbl[128] =
{
  /* 448 byte common FlexSPI configuration block as described in
   * 8.6.3.1 page 223 (RT1060 rev 0)
